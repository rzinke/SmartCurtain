...
def steps_to_take(cursor, desired_position):
	total_steps = DBFunctions.curtain_length(cursor)
	desired_position_steps = total_steps * desired_position / 100
	return DBFunctions.current_position() - desired_position_steps
...
def start_client_loop():
	client = MQTTClient(variables.name, variables.key)
